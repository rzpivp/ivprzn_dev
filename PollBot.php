...
class PollBot extends TelegramBot {
  ...
  public function dbInit() {
    ...
    $this->mysqli = new mysqli($this->cnfg['db_host'], $this->cnfg['db_user'], $this->cnfg['db_pass'], $this->cnfg['db_base']);
...
class PollBotChat extends TelegramBotChat {
  ...
  public function command_getphoto($params, $message) {
    $fName = '/home/ivp/appBot/upload/photo/devushka'.rand(1,9).'.jpg';
    $photo = curl_file_create($fName);
    $this->apiSendObj('sendPhoto', $photo, 'photo', 'Вот така гарна дивчина!');
  }

  public function command_getvideo($params, $message) {
  }

  public function command_getaudio($params, $message) {
  }

  public function command_getdocument($params, $message) {
  }
  ...
  protected function sendHelp() {
    $text = 'Здравствуйте! 😌 Я знаю такие команды:
/start
